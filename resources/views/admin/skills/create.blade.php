...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Add a new skill data to the system.</p>
        </div>
        <a href="{{ route('admin.skills.index') }}" class="btn btn-sm bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-200 border-0 flex items-center gap-2">
        ...
        <form action="{{ route('admin.skills.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text"
                       ...
                       id="name"
                       value="{{ old('name') }}"
                       placeholder="e.g. Basic Mathematics, Web Development..."
            ...
            <div>
                ...
                <textarea name="description"
                          id="description"
                          rows="4"
                          placeholder="Add a brief explanation regarding this subject..."
            ...
            <div class="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-3">
                <a href="{{ route('admin.skills.index') }}" class="btn btn-sm bg-slate-100 text-slate-700 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700 border-0">
                    Cancel
                </a>
